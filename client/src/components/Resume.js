        ...
        <Box className={classes.typedContainer}>
          <Typography align="center">
            <Button
              ...
              href="https://www.dropbox.com/s/07berl05qv02uq2/Joe-Schlick-Developer-Resume-1.6.2021%20-%20Google%20Docs.pdf?dl=0"
              variant="contained"
              size="large"
            >
          ...
          <Accordion 
            ...
            interactive, and presentation content. Creating and managing
          ...
          <Typography className={classes.text} variant="h6">
            ● UC Davis Continuing and Professional Education Bootcamp - Full
            Stack Web Development
            <br />
            ● Santa Fe University of Art and Design (formerly College of Santa
            Fe) - B.A., Moving Image Arts
            <br />● Lewis & Clark College - Art Major
          </Typography>
        </Box>
      </Grid>
    </>
